...
export const STUB_ANALYSIS: AnalysisOutput = {
  ...
  followup_prompts: [
    ...
    },
    {
      ...
      prompt:
        "Проверь на erzrf.ru — какой процент переноса срока сдачи у Эталона за 2024 и 2025 отдельно? Нужны цифры по обоим годам со ссылкой на страницу девелопера.",
      target_info: "Перенос срока Эталон 2024 vs 2025",
      suggested_tool: "perplexity",
    ...
    },
    {
      ...
      prompt:
        "Раздели анализ факторов успеха для двух сегментов отдельно: бизнес-класс (25–45 млн ₽) vs премиум (45+ млн ₽) в Москве. По каждому сегменту — какие факторы (бренд/скорость/продукт) имеют наибольшую корреляцию с долей рынка. Данные за 2023–2025.",
      target_info: "Факторы успеха по сегментам",
      suggested_tool: "openai_dr",
      suggested_source_site: "",
      priority: "nice",
      linked_to: "conflict-1",
    },
  ],
};
