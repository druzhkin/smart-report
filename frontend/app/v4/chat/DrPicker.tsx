...
export const DR_SERVICES: DrServiceMeta[] = [
  ...
  },
  {
    key: "openai",
    label: "OpenAI GPT-4o",
    price: "≈ $0.05–$0.50 / прогон",
    when: "Через OpenRouter: gpt-4o с research-промтом. Опирается на знания модели + рассуждения, без агентского веб-поиска. Хорош для общих рассуждений и структурированной аналитики.",
    mode: "integrated",
  },
  {
    key: "claude",
    label: "Anthropic Claude Sonnet 4.5",
    price: "≈ $0.10–$1.00 / прогон",
    when: "Через OpenRouter: длинный контекст, аккуратные цитаты, sober выводы. Без агентского поиска — на знаниях модели.",
    mode: "integrated",
  },
  {
    key: "gemini",
    ...
    price: "≈ $0.05–$0.50 / прогон",
    when: "Через OpenRouter: gemini-2.5-pro с research-промтом. Без агентского поиска — на знаниях модели. Сильный по структурированию.",
    mode: "integrated",
  },
];
