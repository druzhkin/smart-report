...
2. concreteness — оценивай с учётом source_type каждого finding:
   - 10: >80% утверждений с цифрами опираются на primary_academic / primary_official / primary_data.
   - 7: >50% утверждений с цифрами, большинство — primary_*.
   - 5: цифры есть, но преимущественно из secondary.
   - 3: мало цифр, почти все без первичных источников.
   - 0: общие слова без конкретики.
   Primary_academic с citation_count ≥ 50 — сильный сигнал. Считай долю primary по findings каждого блока.
