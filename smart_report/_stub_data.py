...
MOCK_EXECUTIVE_SUMMARY = {
    "main_finding": (
        "Успех девелопера в бизнес-сегменте Москвы определяется не одним фактором, а сцепкой из трёх: "
        "операционная скорость (–22% цикла у верхнего квартиля), бренд-премия (+8–12% к цене при "
        "идентичной локации) и способность переживать процентные шоки (эластичность спроса −1.3). "
        "Эти три замыкаются в цикл: быстрый цикл освобождает капитал → капитал идёт в бренд → "
        "бренд конвертируется в премию → премия реинвестируется в скорость."
    ),
    "top_numbers": [
        {
            "value": "47%",
            "context": "Доля топ-5 девелоперов в запусках бизнес-класса Москвы в 2024",
            "source_url": "https://www.dom.rf/analytics/2024-business-review/",
        },
        {
            "value": "22%",
            "context": "Сокращение цикла permit→продажи у верхнего квартиля (НИУ ВШЭ)",
            "source_url": "https://www.hse.ru/mirror/pubs/share/dev-cycle-2025.pdf",
        },
        {
            "value": "-1.3",
            "context": "Эластичность спроса бизнес-класса по ставке ипотеки, 2023–2024",
            "source_url": "https://cbr.ru/analytics/mortgage-elasticity/",
        },
    ],
    "key_tensions": [
        {
            "tension": "Концентрация vs. ниша — доминирование топ-5 не исключает viable бутик-проектов",
            "pole_a": "market:structure — топ-5 держат 47% запусков, рост middle-concentration",
            "pole_b": "brand:dynamics — премия бренда работает на масштабе малых проектов тоже",
        },
        {
            "tension": "Скорость как преимущество vs. как источник процикличности",
            "pole_a": "product:mechanism — быстрый цикл = капитал-эффективность",
            "pole_b": "market:dynamics — быстрый цикл усиливает волатильность при ставочном шоке",
        },
    ],
    "open_questions": [
        "Как распределяется концентрация внутри submarket'ов (Внутри-МКАД vs. Новая Москва)?",
        "Сохраняется ли −1.3 эластичность после отмены субсидированной ипотеки?",
        "Какова доля бренд-премии, объясняемая hedonic-качеством продукта vs. чистым trust?",
    ],
}
